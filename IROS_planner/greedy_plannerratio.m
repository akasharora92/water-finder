function [best_action, max_reward] = greedy_plannerratio(robot, BeliefMaps, MapParameters, DKnowledge)
...
for i = 1:size(action_space,1)
    reward_action(i) = greedy_rewardratio(action_space(i,:), robot, BeliefMaps, MapParameters, DKnowledge);
end
