function [best_action, max_reward] = planner_2(robot, bel_space, MapParameters, DKnowledge)
...
for i = 1:size(action_space,1)
    reward_action(i) = getReward_2(action_space(i,:), robot, bel_space, MapParameters, DKnowledge);
end
